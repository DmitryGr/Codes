...
int n = 22;
vector<int> a = {3, 4, 5, 6, 7, 6, 7, 8, 21, 12, 13, 14, 15, 16, 15, 16, 20, 18, 19, 20, 21, -1}; // i -> a[i] в 0-индексации, -1 => нет ребра
vector<int> b = { 1, 2, 4, 5, 8, 7, 8, 18, 20, 10, 11, 13, 14, 17, 16, 17, 17, 19, 20, 21, -1, -1}; // i -> b[i] в 0-индексации, -1 => нет ребра
